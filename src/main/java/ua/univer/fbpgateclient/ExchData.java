...
public static final int MarketOrders = 2;
public static final int NewMarketOrder = 3;
public static final int MarketOwnOrders = 4;
public static final int RejectMarketOrder = 5;
public static final int Portfolio = 6;
public static final int NewUnblockOrder = 7;
public static final int UnblockOrders = 8;
public static final int RejectUnblockOrder = 9;
public static final int StockMarketStatus = 10;
public static final int Contracts = 11;
public static final int SetContractNum = 12;
public static final int MarketOrdersChanges = 13;
public static final int ContractsChanges = 14;
public static final int AllChanges = 15;
...
public static final int QwitAddressOrder = 23;
