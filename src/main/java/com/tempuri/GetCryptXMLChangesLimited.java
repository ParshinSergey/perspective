 ...
 *         &lt;element name="nLimit" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/>
...
@XmlRootElement(name = "GetCryptXMLChangesLimited")
public class GetCryptXMLChangesLimited {
    ...
    /**
     * Gets the value of the nLimit property.
     * 
     * @return
     *     possible object is
     *     {@link Long }
    ...
    /**
     * Sets the value of the nLimit property.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setNLimit(Long value) {
        this.nLimit = value;
    }
