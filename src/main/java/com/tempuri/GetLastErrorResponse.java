...
public class GetLastErrorResponse {
    ...
    @XmlElementRef(name = "GetLastErrorResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> getLastErrorResult;
     ...
     *     
     */
    public JAXBElement<String> getGetLastErrorResult() {
     ...
     *     
     */
    public void setGetLastErrorResult(JAXBElement<String> value) {
